        ...
        <table className="fo-table">
          ...
          <tbody>
            <tr>
              ...
              <td><img src={yes} alt="1"/></td>
              <td><img src={yes} alt="2"/></td>
              <td><img src={yes} alt="3"/></td>
            </tr>
            <tr>
              <td className="fo-h">Захист лаку та фарби</td>
              <td><img src={yes} alt="4"/></td>
              <td><img src={no} alt="5"/></td>
              <td><img src={yes} alt="6"/></td>
            </tr>
            <tr>
              <td className="fo-h">Збереження похідної товщини лаку та фарби</td>
              <td><img src={yes} alt="7"/></td>
              <td><img src={no} alt="8"/></td>
              <td><img src={yes} alt="9"/></td>
            </tr>
            <tr>
              <td className="fo-h">Усунення пор та тріщин</td>
              <td><img src={yes} alt="10"/></td>
              <td><img src={no} alt="11"/></td>
              <td><img src={no} alt="12"/></td>
            </tr>
            <tr>
              <td className="fo-h">Ефект "самоочищення"</td>
              <td><img src={yes} alt="13"/></td>
              <td><img src={no} alt="14"/></td>
              <td><img src={no} alt="15"/></td>
            </tr>
          </tbody>
          <tfoot>
            <tr>
